...
var db *gorm.DB = nil
var gameDb *gorm.DB = nil

func ConnectGameDb(dbHost string, dbPort string, dbName string, dbUser string, dbPassword string) error {
	...
	gameDb, err = gorm.Open(mysqlConfig, &gorm.Config{})
	if err != nil {
